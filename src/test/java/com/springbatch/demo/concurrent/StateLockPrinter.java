...
public class StateLockPrinter {
    ...
    private class Printer implements Runnable {
        ...
        public Printer(Object printLock, int printFlag,int nextPrintFlag, int printCount, char printChar) {
            super();
    ...
    public void test() throws InterruptedException{
        ...
        //打印A的线程
        Thread threadA=new Thread(new Printer(lock, 0,1, 10,'A'));
        //打印B的线程
        Thread threadB=new Thread(new Printer(lock, 1,2, 10,'B'));
        //打印C的线程
        Thread threadC=new Thread(new Printer(lock, 2,0, 10,'C'));
        //一次启动A B C线程
        threadA.start();
        Thread.sleep(1000);
        threadB.start();
